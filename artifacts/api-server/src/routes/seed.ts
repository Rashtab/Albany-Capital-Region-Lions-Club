      ...
      .values([
        {
          ...
          description:
            "You are cordially invited to celebrate the Grand Launch and Chartering Ceremony of the Albany Capital Region Lions Club. Join Lions District 20-R2 for an afternoon of warm camaraderie, elevated inspiration, and the momentous Chartering of our esteemed new Lions Club. Be a part of a historic beginning as we unite to Serve, Inspire, and Impact Lives together. RSVP: President Lion Tahmina Sonia +1 (845) 216-5523",
        ...
        },
        {
          ...
          description:
            "Regular monthly meeting for all members. Agenda includes community project updates and new member introductions.",
        ...
        },
        {
          ...
          description:
            "Free vision screenings for children and adults in partnership with local optometrists. No appointment needed.",
...
We serve. We lead. We improve lives. That is the Lions promise — and it is one we take seriously every day.`,
          excerpt:
            "Announcing the launch of our club blog, where we will share stories, updates, and highlights from the Albany Capital Region Lions Club community.",
          coverImageUrl: null,
      ...
      .values([
        {
          ...
          description:
            "Inaugural Charter Night magazine documenting the founding of Albany Capital Region Lions Club, featuring member profiles, sponsor ads, and our mission statement.",
          isCurrent: true,
        },
      ])
      .onConflictDoNothing();
